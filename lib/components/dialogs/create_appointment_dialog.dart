...
class CreateAppointmentDialog extends StatefulWidget {
  ...
  const CreateAppointmentDialog(
      {super.key, required this.firestoreService, this.appointment});
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (widget.appointment != null) {
        ...
        widget.firestoreService
            ...
            // Pop Dialog
            .then((_) {
              NotificationService.cancelAppointment(widget.appointment!.id.hashCode);
              NotificationService.scheduleAppointment(
                widget.appointment!.id.hashCode,
                'Upcoming Appointment',
                'You have an upcoming $title appointment scheduled on ${DateFormat('HH:mm dd-MM-yyyy').format(appointmentDateTime)}',
                appointmentDateTime
              );
